...
train_pipeline = [
    ...
    # dict(type='Crop', keys=['lq', 'gt'], crop_size=(32, 32), random_crop=True),
    dict(
        type='Normalize',
        keys=['lq'],
        mean=0.5,
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='F:/mengyapeng/dataset/grss2018-me/x32_randomcut/train/HSI_cut',
            gt_folder='F:/mengyapeng/dataset/grss2018-me/x32_randomcut/train/RGBHR_cut',
            pipeline=train_pipeline,
            scale=scale)),
    val=dict(
        type='SRFolderDataset',
        lq_folder='F:/mengyapeng/dataset/grss2018-me/x32_randomcut/valid/HSI_cut',
        gt_folder='F:/mengyapeng/dataset/grss2018-me/x32_randomcut/valid/RGBHR_cut',
        pipeline=test_pipeline,
        scale=scale),
    test=dict(
        type='SRFolderDataset',
        lq_folder='F:/mengyapeng/dataset/grss2018-me/x32_randomcut/test/HSI_cut',
        gt_folder='F:/mengyapeng/dataset/grss2018-me/x32_randomcut/test/RGBHR_cut',
        pipeline=test_pipeline,
        scale=scale))
